...
export default function MitraTambahTransaksi({ namaVenueProps }) {
    ...
    const { data: data, error } = useSWR(`/api/detaillapanganmitradb?idLapangan=${idLapangan}&namaVenueReq=${namaVenue}&namaLapanganReq=${namaLapangan}&tglMainReq=${tglMain}`, fetcher, { refreshInterval: 1000 })
        ...
        <div className="container mt-4">
            ...
            <div className='mt-3'>
                ...
                <div className='row mb-5'>
                    <Link href={'/mitra/transaksi-belum-lengkap'}><button className='btn btn-primary text-white mt-3'>Transaksi Data Belum Lengkap <span className='numberCircle'>{lapanganRes.transaksiBelum.length}</span></button></Link>
                </div>
            </div>
        </div>
