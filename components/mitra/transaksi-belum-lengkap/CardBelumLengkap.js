...
export default function CardListBelumLengkap({ props }) {
                        ...
                        {currentPosts.map((data, index) => (
                            <Link href={{
                                ...
                                <div className="shadow-sm col-12 col-lg-5 border border-2 mb-1 p-3 text-start">
                                    ...
                                    <h4><b>Nama Pemesan:</b> Belum diisi</h4>
                                    ...
                                    <hr></hr>
                                    <h5 ><b>Status: Data Belum Lengkap</b></h5>
                                    <hr></hr>
                                    <Link href={{
                                        pathname: '/mitra/isi-transaksi',
                                        query: {
                                        ...
                                        <a className="btn btn-success text-white p-3 mb-2">Isi Data</a>
                                    </Link>
