                            ...
                            <div className>
                                ...
                                <nav className="list-unstyled">
                                    <li className="list-space">
                                        <a href='#' className="list-menu">Beranda</a>
                                    </li>
                                    <li className="list-space">
                                        <a href='#' className="list-menu">Tentang Kami</a>
                                    </li>
                                    <li className="list-space">
                                        <a href='#' className="list-menu">Lapangan</a>
                                    </li>
                                </nav>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-6">
                            <h2 className="footer-text-title">Pusat Bantuan</h2>
                            <nav className="list-unstyled">
                                <li className="list-space">
                                    <a href className="list-menu">Kontak Kami</a>
                                </li>
                                <li className="list-space">
                                    <a href className="list-menu">Alur Pemesanan</a>
                                </li>
                            </nav>
                        </div>
                    </div>
